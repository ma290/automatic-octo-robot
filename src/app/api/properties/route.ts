  ...
  try {
    ...
    const property = await prisma.property.create({
      data: {
        ...
        attachedBathrooms: propertyData.attachedBathrooms ?? null,
        ...
        possessionStatus: propertyData.possessionStatus ?? null,
        availableFrom: propertyData.availableFrom ? new Date(propertyData.availableFrom) : null,
        isCorner: propertyData.isCorner ?? null,
        mainRoadFacing: propertyData.mainRoadFacing ?? null,
